...
验收依据为 [集成设计](C:/codebase/coresmos/agent-runtime-integration-design.md)、[技术选型](C:/codebase/coresmos/agent-runtime-technology-selection.md) 和 [开发任务清单](C:/codebase/coresmos/agent-runtime-development-tasks.md)。公司内部 I01–I07 没有在本次工作区提供对应实现与环境，状态为未验收；Unibot 仅是参考，不能代替实际内部接入证明。
...
- 位置：[recording.py:352](C:/codebase/coresmos/src/agent_runtime/recording.py:352)。关联 T04、T09。
...
- 位置：[recording.py:344](C:/codebase/coresmos/src/agent_runtime/recording.py:344)。关联 T04。
...
- 位置：[lifecycle.py:107](C:/codebase/coresmos/src/agent_runtime/lifecycle.py:107)、[lifecycle.py:144](C:/codebase/coresmos/src/agent_runtime/lifecycle.py:144)。关联 T03、T11。
...
- 位置：[core.py:132](C:/codebase/coresmos/src/agent_runtime/core.py:132)；初始工具入口的第 99 行同样直接等待 prepare。关联 T03、T07、T11。
...
- 位置：[core.py:118](C:/codebase/coresmos/src/agent_runtime/core.py:118)。关联 T05、T11。
...
- 位置：[core.py:36](C:/codebase/coresmos/src/agent_runtime/core.py:36)、[core.py:133](C:/codebase/coresmos/src/agent_runtime/core.py:133)。关联 T05、T08、T09、T11。
...
- 位置：[pipelines/tools.py:37](C:/codebase/coresmos/src/agent_runtime/pipelines/tools.py:37)、[context/manager.py:91](C:/codebase/coresmos/src/agent_runtime/context/manager.py:91)。关联 T07、T09、T14。
...
- 位置：[context/compress.py:42](C:/codebase/coresmos/src/agent_runtime/context/compress.py:42)、[context/manager.py:115](C:/codebase/coresmos/src/agent_runtime/context/manager.py:115)。关联 T07。
...
- 位置：[context/compress.py:12](C:/codebase/coresmos/src/agent_runtime/context/compress.py:12)。关联 T07。
...
- 位置：[pipelines/model.py:109](C:/codebase/coresmos/src/agent_runtime/pipelines/model.py:109)。关联 T02、T08。
- 依据：[技术选型第 128 行](C:/codebase/coresmos/agent-runtime-technology-selection.md:128) 约定默认保留可识别的未完成输出并结束失败，恢复需要显式启用。
...
- [独立验收用例](C:/codebase/coresmos/acceptance/test_runtime_contracts.py)
- [失败输出](C:/codebase/coresmos/acceptance/contract-results.txt) / [JUnit 结果](C:/codebase/coresmos/acceptance/contract-results.xml)
- [隔离安装 smoke 脚本](C:/codebase/coresmos/acceptance/installed_smoke.py)
- [源文件 SHA-256 清单](C:/codebase/coresmos/acceptance/source-manifest.json)
